...
def create_model(input_shape):
    ...
    # 2. Классификация состояния рынка (3 класса)
    ...
    model.compile(
        ...
        loss_weights=[0.7, 0.3]  # Больший вес для регрессии
    )
    return model
...
def get_entry_signal(data, next_candle, trend_label, trend_prob):
...
if __name__ == '__main__':
    try:
        ...
        entry_signal, confidence = get_entry_signal(data, next_candle, trend_label, trend_prob)
