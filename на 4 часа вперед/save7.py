...
if __name__ == '__main__':
    try:
        ...
        print(f"Spring: {'Да' if last_candle['spring'] else 'Нет'} (всего: {signal_counts['Spring']})")
        print(f"Upthrust: {'Да' if last_candle['upthrust'] else 'Нет'} (всего: {signal_counts['Upthrust']})")
        print(f"Бычье поглощение: {'Да' if last_candle['bullish_engulfing'] else 'Нет'} (всего: {signal_counts['Бычье поглощение']})")
        print(f"Медвежье поглощение: {'Да' if last_candle['bearish_engulfing'] else 'Нет'} (всего: {signal_counts['Медвежье поглощение']})")
        print(f"Кульминация покупок: {'Да' if last_candle['buying_climax'] else 'Нет'} (всего: {signal_counts['Кульминация покупок']})")
        print(f"Кульминация продаж: {'Да' if last_candle['selling_climax'] else 'Нет'} (всего: {signal_counts['Кульминация продаж']})")
        print(f"Накопление: {'Да' if last_candle['accumulation'] else 'Нет'} (всего: {signal_counts['Накопление']})")
        print(f"Распределение: {'Да' if last_candle['distribution'] else 'Нет'} (всего: {signal_counts['Распределение']})")
        print(f"Hammer: {'Да' if last_candle['hammer'] else 'Нет'} (всего: {signal_counts['Hammer']})")
        print(f"Shooting Star: {'Да' if last_candle['shooting_star'] else 'Нет'} (всего: {signal_counts['Shooting Star']})")
